lda_fg <- function(K, V, wid, doc.N, alpha.v, eta, max.iter=100, burn.in=0, spacing=1)
{
  ...
  ret          <- .Call("lda_fg", K, V, doc.N, wid-1, zid-1, alpha.v, eta, max.iter, burn.in, spacing, PACKAGE="ldahp");
