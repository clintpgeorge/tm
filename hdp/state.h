...
public:
	...
	void iterate_gibbs_state(bool remove, bool permute,	hdp_hyperparameter* param, bool table_sampling = false);
	void sample_first_level_concentration(hdp_hyperparameter* param);
	void sample_second_level_concentration(hdp_hyperparameter* param);
	...
	double joint_likelihood(hdp_hyperparameter * param);
...
//	void load_full_state_ex(char * name);
	...
	double update_q_f(doc_state* d_state, int w, double_vec & q, double_vec & f);
